...
Non-Destructive (filters content when called, original text remains in the database)
  ...
  profanity_filter :foo, :bar, :leet => true
    #=> banned words will be tested against common "leet speak" variations of letters
...
=== You can also use the filter directly:
  ...
  ProfanityFilter::Base.clean(text, :method => 'vowels', :leet => true)
  ProfanityFilter::Base.clean(text, :leet => true)
